...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dr. Eddie Mutale" },
      { name: "keywords", content: "Dr Eddie Mutale, The Deal Closer, African Business Strategist, Global Negotiator, African Author, Executive Consultant, Business Consultant Zambia, Strategic Partnerships, International Deal Maker, Thought Leader Africa, Investment Strategist, Visionary Leadership" },
      ...
      { property: "og:url", content: "https://www.dreddiemutale.com" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Dr. Eddie Mutale — The Deal Closer" },
      { name: "twitter:description", content: "Closing strategic deals across 60+ nations globally." },
    ],
    links: [
